...
public class TransferTest {
    ...
    @Test
    void transferOriginAccountDoesNotExist() throws Exception {
    ...
    @Test
    void transferPositiveAmount() throws Exception {
        mockMvc.perform(post("/reset")).andExpect(status().isOk());
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.origin.balance").value(40))
                .andExpect(jsonPath("$.destination.id").value("200"))
